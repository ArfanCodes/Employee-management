...
import { Calendar, Clock, ShieldCheck, ArrowRight, CheckCircle, Menu, X } from 'lucide-react';
...
const Home = () => {
  ...
  <div className="min-h-screen bg-white flex flex-col">
    ...
    {/* ── Hero ─────────────────────────────────────────────────────────── */}
    <section className="flex-1 flex flex-col items-center justify-center px-6 py-28 text-center bg-gradient-to-b from-indigo-50/60 via-white to-white">
      <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 tracking-wide uppercase">
